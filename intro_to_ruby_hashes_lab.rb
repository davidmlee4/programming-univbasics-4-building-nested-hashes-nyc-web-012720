...
def monopoly_with_fourth_tier
  ...
  :names => {
    :reading_railroad => {mortgage_value: $1000},
    :pennsylvania_railroad => {mortgage_value: $1000},
    :b_and_o_railroad => {mortgage_value: $1000},
    :shortline_railroad => {mortgage_value: $1000}
    }}}
end
